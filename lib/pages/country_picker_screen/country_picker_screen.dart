                ...
                children: [
                  ...
                  Obx(() => Column(
                        children: countryPickerController.allCountries
                            .where((country) => countryPickerController.popularCountries
                  ...
                  Expanded(
                    child: Obx(() => ListView.builder(
                          controller: scrollController,
                          itemCount: countryPickerController.filteredCountries.length,
                          itemBuilder: (_, index) {
                            final country = countryPickerController.filteredCountries[index];
                            return InkWell(
                              ...
                              onTap: () {
                                   ...
                                   countryPickerController.selectCountryToShowRates(country);
                              },
                              child: Container(
                                decoration: BoxDecoration(
                                  color: index.isEven
